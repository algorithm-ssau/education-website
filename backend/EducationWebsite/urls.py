...
urlpatterns = [
    ...
    path('courses/<int:course_id>/add_task_block/', TaskBlockCreateView.as_view(), name='add_task_block'),
    path('courses/<int:course_id>/add_theory_block/', TheoryBlockCreateView.as_view(), name='add_theory_block'),
